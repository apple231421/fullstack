...
public class Arrays1 {
    public static void main(String[] args) {
        int[] numbers = { 5, 2, 3, 1, 8 };
        for (int i = 0; i < numbers.length; i++) {
            System.out.print(numbers[i] + " ");
        }
        System.out.println("\n배열 내용: " + Arrays.toString(numbers));
        Arrays.sort(numbers);
        ...
        int[] arr2 = { 1, 2, 3 };
        int[] arr3 = { 3, 2, 1 };
        System.out.println("arr1과arr2같은가? " + Arrays.equals(arr1, arr2));
        System.out.println("arr1과arr3같은가? " + Arrays.equals(arr1, arr3));
        System.out.println("arr2과arr3같은가? " + Arrays.equals(arr2, arr3));
        ...
        int[] copy1 = Arrays.copyOfRange(original1, 1, 4); // index1부터 4번 전까지
